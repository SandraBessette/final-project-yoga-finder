...
const Map = () => {
    const { filters, animatedId, center, zoom } = useSelector(
        (state) => state.map
    );
    ...
    return (
        <MainWrapper>
            <Wrapper>
                ...
                >
                    ...
                    {coordinates && (
                        <Marker
                            position={{
                                lat: coordinates.center[1],
                                lng: coordinates.center[0],
                            }}
                            icon={{
                                url: "/pinCenter.svg",
                                origin: new window.google.maps.Point(0, 0),
            ...
            <SideBar data={business} status={status} />
        </MainWrapper>
    );
};
